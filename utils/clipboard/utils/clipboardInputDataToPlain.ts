import { IClipboardInputBlock, IClipboardInputData, TClipboardInputBlockType } from "../interface";
...
export const clipboardInputDataToPlain = (data: IClipboardInputData): string => {
